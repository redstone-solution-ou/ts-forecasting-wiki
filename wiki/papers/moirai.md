...
- Multivariate evaluation in the main paper leans on the Monash multivariate splits and Long-Sequence Forecasting datasets (ETT, Electricity, Weather); the covariate-informed regime that [chronos-2](./chronos-2.md) and Toto emphasize is only partially covered.
